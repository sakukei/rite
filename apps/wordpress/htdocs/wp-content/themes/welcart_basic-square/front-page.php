            ...
            <div class="main-content">
              <div class="main-content-inner">
                ...
                <div class="main-content-column">
                  <p
                    class="main-content-lead"><?php echo wp_kses_post(wp_trim_words(get_the_content(), 50, '...')); ?></p>
      ...
      while ($item_query->have_posts()) :
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class('card-item'); ?>>
          ...
          <div class="card-item-body">
            <div class="card-item-title"><a href="<?php the_permalink(); ?>"
                                            rel="bookmark"><?php usces_the_itemName(); ?></a></div>
            <div
              class="card-item-price"><?php usces_crform(usces_the_firstPrice('return'), true, false) . usces_guid_tax(); ?></div>
          </div><!-- /card-item-body -->
        </article><!-- /card-item -->
      <?php endwhile; ?>
    </div><!-- /row -->
    <div class="more-items"><a class="btn btn-primary btn-wide-sp"
                               href="<?php echo esc_url(get_category_link(get_category_by_slug('item')->cat_ID)); ?>">もっと見る</a>
    </div>
  </div><!-- /top-items -->
<?php
endif;
                  ...
                  <?php foreach ($traveller_ids as $traveller_id) : ?>
                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class('card-traveller'); ?>>
                      <a href="<?php echo esc_url(get_category_link($traveller_id)); ?>">
                        <div class="card-traveller-img"
                             style="background: url(<?php echo esc_url(get_term_meta($traveller_id, 'wcct-tag-thumbnail-url', true)); ?>) no-repeat center center / cover;">
                      ...
                      <div class="card-traveller-body">
                        <div class="card-traveller-title"><a
                            href="<?php echo esc_url(get_category_link($traveller_id)); ?>"
                            rel="bookmark"><?php echo esc_html($traveller->cat_name); ?></a></div>
                        ...
                        <div class="pickup-content">
                          <div class="pickup-content-inner">
                            ...
                            <div class="pickup-content-column">
                              <?php if (wp_is_mobile()) : ?>
                                <p
                                  class="pickup-content-lead"><?php echo wp_kses_post(wp_trim_words(get_the_content(), 36, '...')); ?></p>
                              <?php else : ?>
                                <p
                                  class="pickup-content-lead"><?php echo wp_kses_post(wp_trim_words(get_the_content(), 50, '...')); ?></p>
                              <?php endif; ?>
