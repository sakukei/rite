...
<!--								</tr>-->
                <tr class="section">
                  <th>パスワード</th>
								...
								<tr class="tr">
									<th class="th" scope="row"><em><?php _e('*', 'usces'); ?></em><?php _e('password', 'usces'); ?></th>
									<td class="td" colspan="2"><input name="member[password1]" id="password1" type="password" value="<?php usces_memberinfo('password1'); ?>" /></td>
								</tr>
								<tr class="tr">
									<th class="th" scope="row"><em><?php _e('*', 'usces'); ?></em><?php _e('Password (confirm)', 'usces'); ?></th>
									<td class="td" colspan="2"><input name="member[password2]" id="password2" type="password" value="<?php usces_memberinfo('password2'); ?>" /></td>
								</tr>
							</table>
